...
export const main = handler(async (event) => {
    ...
    const params = {
        ...
        UpdateExpression: `REMOVE rounds[${data.roundNo - 1}].wordsLeft[${data.oldWordIndex}] SET rounds[${data.roundNo - 1}].score.#teamTurn =  rounds[${data.roundNo - 1}].score.#teamTurn + :increment, turn.wordIndex =:newWordIndex`,
